...
Namespace Framework.Extentions
    Public Class VBCodeGenerator
        ...
        Public Overrides Sub GenerateProject(ByVal databaseName As String)
            MyBase.GenerateProjectXml(databaseName, "$(MSBuildToolsPath)\Microsoft.VisualBasic.targets", m_ListOfTables)
        End Sub
        ...
        Public Overrides Sub ShowAbout()
            MessageBox.Show("VB.Net Code Generator" + vbCrLf + "Copyright (C) 2010 SqlCeExplorer Developement team", APPLICATION_NAME)
        End Sub
    End Class
End Namespace