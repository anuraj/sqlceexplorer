...
Namespace Framework.Extentions
    Public Class Excel2003Importer
        Implements IImportModule
        Private ReadOnly m_fileTypes As String = "Excel 2003 Files|*.xls"
        Private ReadOnly m_fileExtn As String = "XLS"
        Private ReadOnly m_ConnectionString As String = "Provider=Microsoft.Jet.OLEDB.4.0; Data Source={0};Extended Properties=Excel 8.0"
        ...
        Public Sub ShowAbout() Implements Framework.Interfaces.IImportModule.ShowAbout
            MessageBox.Show("MS Excel 2003 File Importer." + vbCrLf + "Copyright (c) 2010 SqlCeExplorer Development team.", APPLICATION_NAME)
        End Sub
    End Class
End Namespace
